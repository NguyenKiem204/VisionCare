  ...
  const bookings = [
    {
      ...
      time: "09:00",
      status: "confirmed",
      notes: "Bệnh nhân cần khám mắt định kỳ",
    },
    {
      id: 2,
      patient: "Trần Thị B",
      ...
      time: "10:30",
      status: "pending",
      notes: "Chụp OCT để kiểm tra võng mạc",
    },
    {
      id: 3,
      patient: "Lê Văn C",
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Xem và quản lý tất cả lịch hẹn khám</p>
      </div>
