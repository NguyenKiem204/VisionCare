...
const MedicalRecordsModal = ({ open, medicalRecord, onClose, onSave }) => {
  ...
  useEffect(() => {
    if (medicalRecord) {
      setForm({
        ...
        visionLeft: medicalRecord.visionLeft || "",
        visionRight: medicalRecord.visionRight || "",
        additionalTests: medicalRecord.additionalTests || "",
    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-[800px] max-h-[90vh] overflow-y-auto">
        <h2 className="text-lg font-bold mb-4 text-gray-900 dark:text-white">
          {medicalRecord ? "Sửa hồ sơ bệnh án" : "Thêm hồ sơ bệnh án mới"}
        </h2>
